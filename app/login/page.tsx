...
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Don't set isLoading to false on success
      // The loading state will persist during navigation
      setIsRedirecting(true)
      router.push("/college-application")
    }
  }

  // Show full-page loading overlay when redirecting after successful login
  if (isRedirecting) {
    return (
