...
export default function SharedCollegeApplicationPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch academics, extracurriculars, awards, and essays
        const [
          academicsResponse,
          testScoresResponse,
  ...
  if (shareData && shareData.expires_at) {
                      ...
                      <Card key={college.id}>
                        ...
                        <CardContent>
                          ...
                          <div className="mt-3 flex flex-wrap gap-2">
                            ...
                            {college.is_liked && <Badge variant="secondary">Favorite</Badge>}
                          </div>
                        </CardContent>
                      </Card>
                    ))}
